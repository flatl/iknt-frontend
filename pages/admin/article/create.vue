  ...
  <main class="admin-article">
    <div v-if="article" class="admin-article__container">
      ...
      <div class="admin-article__controls">
        <button class="admin-article__button save" @click="handleCreate">
...
export default defineComponent({
  ...
  methods: {
    ...
    async handleCreate() {
      ...
      const response = await this.$api.createArticle(this.article);

      if (response.success) {
        this.$toast.success('Статья успешно создана', { duration: 2e3 });
